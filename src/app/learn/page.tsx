...
const learnTopics = [
  {
    ...
    description: 'Understand Big O, Omega, and Theta notations with visual time/input graphs and array operations.',
  },
  {
    id: 'stack',
    unit: { number: 2, name: 'Stack and Queues' },
    title: 'Stacks & Recursion',
    description: 'Explore stack operations, postfix/infix expressions, and recursion call stacks like factorial and Fibonacci.',
  },
  {
    id: 'queue',
    unit: { number: 2, name: 'Stack and Queues' },
    title: 'Queues',
    description: 'Learn about simple and circular queues with enqueue/dequeue operations and real-world applications.',
  },
  {
    id: 'linkedlist',
    unit: { number: 3, name: 'Linked List' },
    title: 'Linked Lists',
    description: 'Interact with singly, circular, and doubly linked lists. Perform insert, delete, search, and count operations.',
  },
  {
    id: 'trees',
    ...
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="mb-8 lg:mb-12">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-zinc-900 dark:text-zinc-100 mb-3 lg:mb-4">
            Data Structures Learning Path
          </h1>
          <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-300 max-w-3xl">
